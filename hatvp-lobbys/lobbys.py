    ...
    for ex in firme['exercices']:
        ...
        if 'activites' in ex:
            for act in ex['activites']:
                dictio=act['publicationCourante']
                printjs(dictio)
                input(len(dictio['actionsRepresentationInteret']))
                for action in dictio['actionsRepresentationInteret']:
                    print('new action')
                    for cible in action['reponsablesPublics']:#sic...
                        ...
                        print("cible:",cible)
                        if cible.startswith('Membre du Gouvernement ou membre de cabinet'):# ministeriél -'):
                            input(cible)
                        ...
                        if cible.startswith("Directeur ou secretaire general, ou leur adjoint, ou membre du college ou d'une commission des sanctions d'une autorite administrative ou publique independante -"):
