...
function adaptZoom() {
    ...
    scaleFactor = 1//zoom.scale() * Math.pow(oldNodesNumber / (newNodesNumber),0.5) //(width - 100) / (200 * (infoWidth / 150 + Math.sqrt(net.nodes.length) + 1)) / params.zoomFactor
        ...
        if (d.type === "Links" || d.type === "Contains") {
            ...
            infoSubBlock
                ...
                .attr("y", function(d) {
                    ...
                    blockHeight = blockHeight + infoTextSize * Math.floor(3 + .55 * d.value.length * infoTextSize / (infoWidth*.8));
                    return d.height+15
                })
                .text(d => d.value)
